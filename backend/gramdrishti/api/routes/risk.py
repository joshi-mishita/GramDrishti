...
from gramdrishti.api.deps import ERRORS_503, service
...
@router.get("/risk", response_model=s.Risk, responses=ERRORS_503)
...
@router.get("/priority", response_model=s.Priority, responses=ERRORS_503)
